    ...
    <div className="min-h-screen bg-[#fbf8ef] text-black flex items-center justify-center p-6">
      ...
      >
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <h1 className="form-heading text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#80CBC4] to-orange-400">
            Welcome Back
          </h1>
        </div>
        ...
        <p className="text-center mt-6 text-gray-400">
          New to ThriveTrack AI?{' '}
          <Link 
            to="/signup" 
            className="text-orange-400 hover:text-blue-300 transition-colors font-medium"
          >
            Create an account
          </Link>
        </p>
